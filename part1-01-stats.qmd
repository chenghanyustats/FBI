...
knitr::include_graphics("./images/img-part1/statistics.jpg")
```
...
![](./images/img-part1/data_science_stats.png){#fig-twit-josh}

![](./images/img-part1/data_science_sf.png){#fig-twit-jeremy}

![Tweets about what Data Science is](./images/img-part1/data_science_mac.png){#fig-twit-borat}
...
![Professor Ariely on Big Data](./images/img-part1/big_data.png){#fig-bigdata}
...
knitr::include_graphics("./images/img-part1/ucsc_courses.png")
```
...
knitr::include_graphics("./images/img-part1/ds_process.jpeg")
```
...
```{r}
#| out-width: 30%
knitr::include_graphics("./images/img-part1/bookchapter.png")
```
